...
public enum HelpCategories {
	...
	/**
	 * This is the default value for the category. It is used when the category is
	 * not known.
	 */
	UNKNOWN(-1),

	/**
	 * This category is used for the overview of all commands. It is used to give a
	 * general overview of all commands.
	 */
	OVERVIEW(0),

	/**
	 * This category is used for all generic commands. These are commands that do
	 * not fit into any other category.
	 */
	GENERIC(1),

	/**
	 * This category is used for all tools commands. These are commands that are
	 * used to help the user with various tasks.
	 */
	TOOLS(2),

	/**
	 * This category is used for all moderation commands. These are commands that
	 * are used to moderate the server.
	 */
	MODERATION(3),

	/**
	 * This category is used for all music commands. These are commands that are
	 * used to play music.
	 */
	MUSIC(4);
