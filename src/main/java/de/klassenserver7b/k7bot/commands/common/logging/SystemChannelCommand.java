/* (C)2026 */
package de.klassenserver7b.k7bot.commands.common.logging;
...
public class SystemChannelCommand implements ServerCommand {
	...
	public String getHelp() {
		return """
				Ändert den Channel für Systembenachrichtigungen (z.B. Logs für Einladungen oder\
				 gelöschte Nachrichten) des Bots auf diesem Server.
				 - kann nur von Personen mit der Berechtigung 'Server Verwalten' ausgeführt\
				 werden!
	...
	public void performCommand(Member m, GuildMessageChannel channel, Message message) {
		...
		if (m.hasPermission(Permission.MANAGE_SERVER)) {
			...
			if (!message.getMentions().getChannels(GuildMessageChannel.class).isEmpty()) {
				...
				SyntaxError.onCmdSyntaxError(channel, m, "syschannel [@new syschannel]");
			}
		}
	}
