...
public class VersionCommand implements ServerCommand {
	/**
	 * @return The Help for the {@link ServerCommand ServerCommand}
	 */
	@Override
	...
	/**
	 * @return The Category for the {@link ServerCommand ServerCommand}
	 */
	@Override
	...
	/**
	 * @return The Command Strings for the {@link ServerCommand ServerCommand}
	 */
	@Override
